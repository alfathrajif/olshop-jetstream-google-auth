...
<head>
    ...
    <link href="{{ asset('build/assets/dashboard/plugins/custom/fullcalendar/fullcalendar.bundle.css')}}"
        rel="stylesheet" type="text/css" />
    <!--end::Page Vendors Styles-->
    <!--begin::Global Theme Styles(used by all pages)-->
    <link href="{{ asset('build/assets/dashboard/plugins/global/plugins.bundle.css')}}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('build/assets/dashboard/plugins/custom/prismjs/prismjs.bundle.css')}}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('build/assets/dashboard/css/style.bundle.css')}}" rel="stylesheet" type="text/css" />
    <!--end::Global Theme Styles-->
    <!--begin::Layout Themes(used by all pages)-->
    <link href="{{ asset('build/assets/dashboard/css/themes/layout/header/base/light.css')}}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('build/assets/dashboard/css/themes/layout/header/menu/light.css')}}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('build/assets/dashboard/css/themes/layout/brand/dark.css')}}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('build/assets/dashboard/css/themes/layout/aside/dark.css')}}" rel="stylesheet"
        type="text/css" />
    <!--end::Layout Themes-->
    <link rel="shortcut icon" href="{{ asset('build/assets/dashboard/media/logos/favicon.ico')}}" />
</head>
<!--end::Head-->
<!--begin::Body-->
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        <!--begin::Logo-->
        <a href="index.html">
            <img alt="Logo" src="{{ asset('build/assets/dashboard/media/logos/logo-light.png')}}" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="build/dashboard/custom/apps/inbox.html" class="menu-link">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="card card-custom card-stretch gutter-b">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="pt-5">
                                            <p class="text-center font-weight-normal font-size-lg pb-7">Data Pengunjung
                                                Harian
                                                <a href="#"
                                ...
                                <div class="card card-custom card-stretch gutter-b">
                                    ...
                                    <div class="card-header border-0 py-5">
                                        <h3 class="card-title align-items-start flex-column">
                                            <span class="card-label font-weight-bolder text-dark">Data Transaksi
                                                Pelanggan Terbaru</span>
                                            <span class="text-muted mt-3 font-weight-bold font-size-sm">Rincian
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <div class="symbol symbol-50 symbol-light mr-4">
                                                                        <span class="symbol-label">
                                                                            <img src="{{ asset('build/assets/dashboard/media/svg/avatars/001-boy.svg') }}"
                                                            ...
                                                            <td>
                                                                <img src="{{ asset('build/assets/dashboard/media/logos/stars.png')}}"
                                                        ...
                                                        <tr>
                                                            <td class="pl-0 py-0">
                                                                <div class="d-flex align-items-center">
                                                                    <div class="symbol symbol-50 symbol-light mr-4">
                                                                        <span class="symbol-label">
                                                                            <img src="{{ asset('build/assets/dashboard/media/svg/avatars/018-girl-9.svg')}}"
                                                                                class="h-75 align-self-end" alt="" />
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                        ...
                                                        <tr>
                                                            <td class="pl-0 py-8">
                                                                <div class="d-flex align-items-center">
                                                                    <div class="symbol symbol-50 symbol-light mr-4">
                                                                        <span class="symbol-label">
                                                                            <img src="{{ asset('build/assets/dashboard/media/svg/avatars/047-girl-25.svg')}}"
                                                                                class="h-75 align-self-end" alt="" />
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                        ...
                                                        <tr>
                                                            <td class="pl-0 py-0">
                                                                <div class="d-flex align-items-center">
                                                                    <div class="symbol symbol-50 symbol-light mr-4">
                                                                        <span class="symbol-label">
                                                                            <img src="{{ asset('build/assets/dashboard/media/svg/avatars/014-girl-7.svg')}}"
                                                                                class="h-75 align-self-end" alt="" />
                                                                        </span>
                                                                    </div>
                                                                    <div>
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label"
                        style="background-image:url({{ asset('build/assets/dashboard/media/users/300_21.jpg') }})">
                    </div>
            ...
            <div class="offcanvas-wrapper mb-5 scroll-pull">
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="{{ asset('build/assets/dashboard/media/stock-600x400/img-1.jpg')}}" title="" alt="" />
                    </a>
                </div>
                <!--end::Item-->
                <!--begin::Separator-->
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="{{ asset('build/assets/dashboard/media/stock-600x400/img-2.jpg')}}" title="" alt="" />
                    </a>
                </div>
                <!--end::Item-->
                <!--begin::Separator-->
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="{{ asset('build/assets/dashboard/media/stock-600x400/img-3.jpg')}}" title="" alt="" />
                    </a>
                </div>
                <!--end::Item-->
                <!--begin::Separator-->
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="{{ asset('build/assets/dashboard/media/stock-600x400/img-4.jpg') }}" title=""
                            alt="" />
                    </a>
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="{{ asset('build/assets/dashboard/media/stock-600x400/img-8.jpg') }}" title=""
                            alt="" />
                    </a>
                </div>
                <!--end::Item-->
                    ...
                    <div class="mb-15">
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="{{ asset('build/assets/dashboard/media/svg/misc/006-plurk.svg') }}"
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="{{ asset('build/assets/dashboard/media/svg/misc/015-telegram.svg') }}"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="{{ asset('build/assets/dashboard/media/svg/misc/003-puzzle.svg') }}"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="{{ asset('build/assets/dashboard/media/svg/misc/005-bebo.svg')}}"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="{{ asset('build/assets/dashboard/media/svg/misc/014-kickstarter.svg')}}"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                ...
                                <div class="d-flex flex-column mb-5 align-items-start">
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-circle symbol-40 mr-3">
                                            <img alt="Pic"
                                                src="{{ asset('build/assets/dashboard/media/users/300_12.jpg') }}" />
                                        </div>
                                        <div>
                                            <a href="#"
                                ...
                                <div class="d-flex flex-column mb-5 align-items-end">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-circle symbol-40 ml-3">
                                            <img alt="Pic"
                                                src="{{ asset('build/assets/dashboard/media/users/300_21.jpg') }}" />
                                        </div>
                                    </div>
                                    <div
    ...
    <script src="{{ asset('build/assets/dashboard/plugins/global/plugins.bundle.js') }}"></script>
    <script src="{{ asset('build/assets/dashboard/plugins/custom/prismjs/prismjs.bundle.js') }}"></script>
    <script src="{{ asset('build/assets/dashboard/js/scripts.bundle.js') }}"></script>
    <!--end::Global Theme Bundle-->
    <!--begin::Page Vendors(used by this page)-->
    <script src="{{ asset('build/assets/dashboard/plugins/custom/fullcalendar/fullcalendar.bundle.js') }}"></script>
    <!--end::Page Vendors-->
    <!--begin::Page Scripts(used by this page)-->
    <script src="{{ asset('build/assets/dashboard/js/pages/widgets.js') }}"></script>
    <!--end::Page Scripts-->
</body>
<!--end::Body-->
